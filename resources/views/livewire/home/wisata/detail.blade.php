    ...
    <div class="row align-items-center min-vh-50">
      <div class="col-md-12 col-lg-12 text-center text-md-start" style="margin-top: -65px;">
        ...
        <div class="card border shadow-lg p-lg-4 pt-lg-4 p-0 pt-3" style="border-radius: 30px;">
          <div class="card-body">
            <h2 class="fw-bold text-center">Wisata <span class="text-primary">{{ $wisata->name }}</span></h2>
            <h6 class="text-center px-3">{{ $wisata->address }}</h6>
                        ...
                        @if ($wisata->ticket_stock != 0)
                          <div class="mb-3">
                            ...
                            <input required wire:model="qty" type="number" class="form-control text-secondary"
                              min="1" max="{{ $wisata->ticket_stock }}" id="quantity">
                          </div>
              ...
              <div class="col-md-5 pt-lg-3 pt-0 pe-lg-3 ps-lg-3 ps-2 pe-2">
                <div class="card">
                  <div class="card-body">
                    ...
                    {{-- <img class="img-fluid" src="https://ilmifaizan.web.id/sneat/img/maps/maps.png" alt="Image"> --}}
                    <div class="mapouter">
