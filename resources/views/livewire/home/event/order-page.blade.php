    ...
    <div class="row align-items-center min-vh-25">
      <div class="col-md-12 col-lg-12 text-center text-md-start" style="margin-top: -65px;">
        ...
        <div class="card border shadow-lg p-lg-4 pt-lg-4 p-0 pt-3 pb-3" style="border-radius: 30px;">
          <div class="card-body">
            <h2 class="fw-bold text-center">Event <span class="text-primary">Checkout</span></h2>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-5">
                        <img src="{{ asset("storage/$cover") }}" alt="Image" class="img-fluid"
                          style=" 
                          height: 105px; 
                          object-fit: cover;
                    ...
                    <div class="d-flex justify-content-between mt-3">
                      ...
                      <h6 class="fw-bold" style="font-size: 1rem;">Rp {{ number_format($total, 0, ',', '.') }}
                      </h6>
                    </div>
                  </div>
                </div>
                ...
                <div class="card border" style="border-bottom-left-radius: 6px; border-bottom-right-radius: 6px;">
                  ...
                  <div class="d-flex">
                    <div wire:click="checkoutConfirm" class="btn w-75 btn-primary mt-2 me-1"
                      ...
                      Checkout</div>
                    <a href="{{ url("/semua-event/$eventId") }}" class="btn w-50 btn-danger mt-2"
                      style="border-top-left-radius: 0; border-top-right-radius: 0; ">
                      Kembali</a>
                  </div>
                </div>
