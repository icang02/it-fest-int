<div wire:id="59thO3yAGJIZ50s19XyG" class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Wisata & Event / My Wisata /</span> Edit </h4>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="mb-3">
                ...
                <textarea rows="5" wire:model="description" class="form-control @error('description') is-invalid @enderror"
              ...
              <div class="mb-3 col-md-4">
                ...
                @if ($cover)
                  <img src="{{ $cover->temporaryUrl() }}" alt="Cover" class="d-block mt-2 mb-1 img-thumbnail"
                    width="200" />
                @else
                  <img src="{{ asset("storage/$previewCover") }}" alt="Cover" class="d-block mt-2 mb-1 img-thumbnail"
                    width="200" />
                @endif
                {{-- End Image Cover --}}
