        ...
        <div class="table-responsive text-nowrap pb-3">
          <table class="table table-borderless">
            ...
            <tbody>
              <tr>
                <td>
                  <img src="{{ asset("storage/$cover") }}" alt="thumbnail.jpg" width="110">
                </td>
                <td>
                  <span class="fw-bold">
                    <a class="text-dark" href="{{ url('event/' . $eventId) }}"> {{ $name }} </a>
                  </span> <br>
                  <span> {{ $place }} </span>
                </td>
              ...
              <tr>
                <td colspan="3"><a class="btn btn-sm btn-success" href="{{ route('event') }}">
                    See All Events </a></td>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-body text-center">
          <div class="fs-5 fw-bold text-primary"> Total : Rp {{ number_format($total, 0, ',', '.') }}</div><br>
          <div>
